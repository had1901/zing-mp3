...
function Account() {
  ...
  return (
    <div className={`${state.backgroundPopupSetting} w-[300px] absolute top-[115%] right-0 ${state.textColor} rounded-md h-[720px] shadow-account overflow-y-auto overscroll-y-contain`}>
        <div className='p-3'>
            ...
            <div className='before:mt-4 before:block before:w-4/5 before:h-[1px] before:bg-[#ffffff1a] '>
                <div className='py-3 '>
                    ...
                    <div className='flex items-center gap-3 p-2 hover:bg-[#ffffff1a] rounded-md cursor-pointer'>
