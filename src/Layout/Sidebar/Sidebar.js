...
function Sidebar() {
  ...
  return (
    <section ref={bgSidebar.sidebarRef} datatype='sidebar' className={`h-90 xl:translate-x-0 ${bgSidebar.isActiveSidebar === true ? 'sm:translate-x-0 xs:bg-smSidebarScreen shadow-sidebarShadow' : 'xs:-translate-x-full'}  transition-all fixed overflow-scroll z-50 text-white ${bgSidebar.sideBar}`}>
