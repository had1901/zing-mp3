...
import { Chills, Haha, Top100 } from '../../mp3/Music/Music'
...
function TopRank() {
  ...
  return (
    <div className='w-full'>
      ...
      <div className='ml-60 px-14 pt-16 h-full pb-24 overflow-scrollbar flex justify-center flex-wrap text-white'>
        <div>
                ...
                Top100.map((item, index) => (
                  <div key={index}>
                    <Title title={item.title} classNameMore='text-xl my-5'/>       
                      <div className='flex flex-wrap gap-y-14 -mx-3 hi'>   
                          {
                            item.card.map((cardItem, index) => (    
                                          
                                <Content key={index} description={cardItem.desc} thumb='' dataThumb={cardItem.thumb && cardItem.thumb} classNameChild='lazy-load' classNameParent='w-1/5 mt-0' classWrapImg='px-3'/>
                            ))
