...
import { Haha, Top100 } from './../mp3/Music/Music'
                        ...
                        <div className='grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-4'>   
                            {
                              item.card.map((cardItem, index) => (    
                                  <Content key={index} description={cardItem.desc} thumb='' dataThumb={cardItem.thumb && cardItem.thumb} classNameChild='lazy-load' classNameParent=' mt-0' classWrapImg=''/>
                              ))
                            }
                        </div>
                    </div>
